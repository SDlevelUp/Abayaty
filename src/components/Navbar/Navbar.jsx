...
const Navbar = () => {
    ...
    return (
        <nav className="bg-white md:p-10 md:pb-0 p-3 shadow-xl z-50 fixed w-full">
            ...
            <ul className="text-black font-montserrat font-normal md:flex hidden uppercase items-center justify-center lg:pt-5 whitespace-nowrap" >
                <NavLinks />
            </ul>
            {/* Mobile nav */}
            <ul
